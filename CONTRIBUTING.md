...
- **Fork the repo**
- **Clone the repo** and set it up (check out the [manual installation](https://github.com/CracKerMe/node-express-boilerplate#manual-installation) section in README.md)
